        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="btn w80 fr mr30 applyBtn"></button>&nbsp;' +
                    '<button class="btn w80 fr mr30  cancelBtn"></button>' +
                  '</div>' +
                '</div>' +
                '<div class="clear"></div>'+
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="icon-date_left icon"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i class="icon-date_right icon"></i></th>';
            } else {
                html += '<th></th>';
            }
